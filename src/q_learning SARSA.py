...
#Define transition tuple for prettier code
...
class QLearningAgent(BaseAgent):
    def __init__(self, 
        ...
        self.memory = BufferReplay(buffer_capacity)
    ...
    def learn(self, state, action, reward, next_state, done):
        ...
        self.q_table[state, action] += self.lr (reward + self.gamma * self.q_table[next_max] - old_value)
